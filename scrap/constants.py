SECstate_country_code = {
    ...
    'WV':	'WEST VIRGINIA',
    'WI':	'WISCONSIN',
    'WY':	'WYOMING',          # all the states, Canada provinces next
    'A0':   'ALBERTA, CANADA',
    ...
    'B0':	'YUKON, CANADA',
    'Z4':	'CANADA (Federal Level)', # all the provinces, Countries next
    'B2':	'AFGHANISTAN',
    'Y6':	'ALAND ISLANDS',
    'B3':	'ALBANIA',
    'B4':	'ALGERIA',
